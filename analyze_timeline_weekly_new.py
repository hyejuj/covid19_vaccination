...
keywords = ['immunity', 'immune', 'vaccine', 'vaccination', 'herd', 'rollout', 'mrna', 
        'distribution', 'side effect', 'reaction', 'dose', 'campaign', 'candidate',
        'antibody', 'antibodies', 'anti-vaxxer', 'adverse', 'response', 'adenovirus',
        'astrazeneca', 'moderna', 'pfizer', 'johnson', 'allergy', 'allergic']
...
if __name__ == '__main__':
    input_loc = 'ca'
    input_prefix = '../twitter_standard/tweets_%s_v_en' % input_loc# _0.txt'
    input_num = 6 # 5 files
    output_file = 'sentiment_time_v_%s.csv' % input_loc
